...
var djA_cfg_ConfigFileB = function(cont) {
...
djNode_utils_Print2.prototype = {
	...
	,tc: function(text,ind,charpad) {
		...
		if(ind >= this._table.length) {
			haxe_Log.trace("Table Cell (" + this._tActiveCell + ") Overflow, for text (" + text + ")",{ fileName : "djNode/utils/Print2.hx", lineNumber : 303, className : "djNode.utils.Print2", methodName : "tc"});
			return;
		}
